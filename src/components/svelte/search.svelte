...
<div class="flex justify-center pt-4 md:pt-1">
<div class="items-left md:items-center">
    <input type="text" bind:value={text} on:input={searchReq} placeholder="Search" class="input input-bordered input-primary flex justify-center w-full md:w-auto tems-center"/>
    <div class="flex flex-col overflow-y-auto sm:fixed max-h-72 w-96 card bg-info-content shadow-xl rounded-lg mt-2">
        {#each results as res}
