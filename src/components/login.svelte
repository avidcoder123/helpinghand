...
<div class="items-center">
    {#if onClient}
        {#await auth()}
            <h1 class="text-center text-5xl pt-10 text-white">Logging in...</h1>
            <h2 class="text-center text-3xl pt-5 text-white">You should have a popup to login with Google.</h2>
        {:catch err}
